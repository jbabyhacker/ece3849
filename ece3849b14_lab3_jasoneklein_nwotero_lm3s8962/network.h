...
#define MSG_NUM_RX 2 // message number 1...32
#define MSG_NUM_TX 1 // these can be constant on both communicating boards

extern volatile unsigned long g_ulFrequency;
